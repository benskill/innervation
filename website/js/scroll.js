...
$( document ).scroll(function() {
	...
	var aboutSection = $('#section-about').offset().top;  // the top (y) location of your element
	var stylesSection = $('#section-styles').offset().top;  // the top (y) location of your element
	var listenSection = $('#section-listen').offset().top;  // the top (y) location of your element
	var videoSection = $('#section-video').offset().top;  // the top (y) location of your element
	var bookSection = $('#section-book').offset().top;  // the top (y) location of your element
